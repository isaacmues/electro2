...
Tenemos que la energÌa≠a contenida para un dipolo con momento $`\vec{p}`$
...
Adem·s el campo elÈctrico provocado por este en un punto $`\vec{r}`$
...
Entonces, la energÌa≠a requerida es
